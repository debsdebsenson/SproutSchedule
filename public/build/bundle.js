...
var app = (function () {
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$5, 8, 8, 117);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$5, 11, 8, 183);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    		},
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			button = element("button");
    			button.textContent = "Third Page";
    			add_location(button, file$5, 14, 8, 255);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(nav, file$5, 6, 0, 85);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			p.textContent = "© 2024 Deborah Sobiella. All rights reserved.";
    			add_location(p, file$4, 7, 4, 100);
    			add_location(footer, file$4, 6, 0, 87);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			button = element("button");
    			button.textContent = "Go to Second Page";
    			add_location(h1, file$3, 10, 0, 157);
    			attr_dev(button, "class", "svelte-1vsly3y");
    			add_location(button, file$3, 11, 0, 191);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*goToSecondPage*/ ctx[0], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ navigate, goToSecondPage });
    ...
    /* src/pages/SecondPage.svelte generated by Svelte v3.59.2 */

    const file$2 = "src/pages/SecondPage.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Second Page";
    			t1 = space();
    			p = element("p");
    			p.textContent = "This is the content of the second page.";
    ...
    function instance$2($$self, $$props) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('SecondPage', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<SecondPage> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class SecondPage extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src/pages/ThirdPage.svelte generated by Svelte v3.59.2 */

    const file$1 = "src/pages/ThirdPage.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Third Page";
    			t1 = space();
    			p = element("p");
    			p.textContent = "This is the content of the third page.";
    ...
    function instance$1($$self, $$props) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('ThirdPage', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<ThirdPage> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class ThirdPage extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_default_slot(ctx) {
    	...
    	route1 = new Route({
    			props: { path: "/second", component: SecondPage },
    			$$inline: true
    		});

    	route2 = new Route({
    			props: { path: "/third", component: ThirdPage },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 17, 12, 449);
    			add_location(header, file, 16, 8, 428);
    			add_location(main, file, 20, 8, 551);
    			attr_dev(div, "class", "container");
    			add_location(div, file, 15, 4, 396);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
